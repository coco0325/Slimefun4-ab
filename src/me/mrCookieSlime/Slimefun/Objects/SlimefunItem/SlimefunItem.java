...
public class SlimefunItem {
    ...
    public static SlimefunItem getByItem(ItemStack item) {
        ...
        for (SlimefunItem sfi : items) {
            ...
            else if (sfi instanceof DamagableChargableItem && SlimefunManager.isItemSimiliar(item, sfi.getItem(), false))
                return sfi;
            else if (sfi instanceof ChargedItem && SlimefunManager.isItemSimiliar(item, sfi.getItem(), false))
                return sfi;
            else if (sfi instanceof SlimefunBackpack && SlimefunManager.isItemSimiliar(item, sfi.getItem(), false))
                return sfi;
    ...
    public boolean isItem(ItemStack item) {
        ...
        else if (this instanceof DamagableChargableItem && SlimefunManager.isItemSimiliar(item, this.item, false))
            return true;
