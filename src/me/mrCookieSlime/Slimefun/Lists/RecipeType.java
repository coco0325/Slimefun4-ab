...
public class RecipeType {
	...
	public static final RecipeType MULTIBLOCK = new RecipeType(new CustomItem(Material.BRICK, "&b方塊機器", "", "&a&o照著說明建造在世界中"));
	public static final RecipeType ARMOR_FORGE = new RecipeType(new CustomItem(Material.ANVIL, "&b盔甲鍛造台", "", "&a&o使用鍛造台鍛造得到"), "ARMOR_FORGE");
	public static final RecipeType GRIND_STONE = new RecipeType(new CustomItem(Material.DISPENSER, "&b磨石", "", "&a&o使用磨石來打磨"), "GRIND_STONE");
	public static final RecipeType MOB_DROP = new RecipeType(new CustomItem(Material.IRON_SWORD, "&b生物掉落物", "", "&a&o殺死特定生物得到"));
	public static final RecipeType SMELTERY = new RecipeType(new CustomItem(Material.FURNACE, "&6冶煉爐", "", "&a&o使用冶煉爐來燒製物品"), "SMELTERY");
	public static final RecipeType ORE_CRUSHER = new RecipeType(new CustomItem(Material.DISPENSER, "&b碎礦機", "", "&a&o使用碎礦機碎礦"), "ORE_CRUSHER");
	public static final RecipeType GOLD_PAN = new RecipeType(new CustomItem(Material.BOWL, "&b淘金盤", "", "&a&o使用淘金盤淘金獲得"));
	public static final RecipeType COMPRESSOR = new RecipeType(new CustomItem(Material.PISTON, "&b壓縮機", "", "&a&o使用壓縮機壓縮得到"), "COMPRESSOR");
	public static final RecipeType PRESSURE_CHAMBER = new RecipeType(new CustomItem(Material.GLASS, "&b壓力室", "", "&a&o使用壓力室得到"), "PRESSURE_CHAMBER");
	public static final RecipeType OVEN = new RecipeType(new CustomItem(Material.FURNACE, "&b燒製", "", "&a&o燒製得到"), "OVEN");
	public static final RecipeType MAGIC_WORKBENCH = new RecipeType(new CustomItem(Material.BOOKSHELF, "&6魔法工作台", "", "&a&o在魔法工作台合成"), "MAGIC_WORKBENCH");
	public static final RecipeType ORE_WASHER = new RecipeType(new CustomItem(Material.CAULDRON, "&6洗礦機", "", "&a&o在洗礦機內清洗"), "ORE_WASHER");
	public static final RecipeType ENHANCED_CRAFTING_TABLE = new RecipeType(new CustomItem(Material.CRAFTING_TABLE, "&e進階工作台", "", "&a&o普通的工作台", "&a&o無法承受這巨大的力量..."), "ENHANCED_CRAFTING_TABLE");
	public static final RecipeType JUICER = new RecipeType(new CustomItem(Material.GLASS_BOTTLE, "&e果汁機", "", "&a&o使用果汁機得到"), "JUICER");
	public static final RecipeType ANCIENT_ALTAR = new RecipeType(new CustomItem(Material.ENCHANTING_TABLE, "&4遠古魔法祭壇", "", "&d你需要將這些物品", "&d擺放到遠古祭壇的基座上(書本合成表的上方是祭壇的東方)"));
